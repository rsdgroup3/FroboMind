...
if(NOT "/usr/local/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include" STREQUAL "")
  set(image_geometry_INCLUDE_DIRS "")
  foreach(idir /usr/local/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /usr/local/${idir})
      set(include /usr/local/${idir})
    else()
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Vincent Rabaud <vrabaud@willowgarage.com>' to fix it.")
    endif()
