...
if(TRUE)
  set(image_geometry_SOURCE_PREFIX /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/devel)
...
if(NOT "/home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include" STREQUAL "")
  set(image_geometry_INCLUDE_DIRS "")
  foreach(idir /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/${idir})
      set(include /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/${idir})
    else()
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vrabaud@willowgarage.com>' to fix it.")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/opt/ros/groovy/lib/libopencv_calib3d.so;/opt/ros/groovy/lib/libopencv_contrib.so;/opt/ros/groovy/lib/libopencv_core.so;/opt/ros/groovy/lib/libopencv_features2d.so;/opt/ros/groovy/lib/libopencv_flann.so;/opt/ros/groovy/lib/libopencv_gpu.so;/opt/ros/groovy/lib/libopencv_highgui.so;/opt/ros/groovy/lib/libopencv_imgproc.so;/opt/ros/groovy/lib/libopencv_legacy.so;/opt/ros/groovy/lib/libopencv_ml.so;/opt/ros/groovy/lib/libopencv_nonfree.so;/opt/ros/groovy/lib/libopencv_objdetect.so;/opt/ros/groovy/lib/libopencv_photo.so;/opt/ros/groovy/lib/libopencv_stitching.so;/opt/ros/groovy/lib/libopencv_video.so;/opt/ros/groovy/lib/libopencv_videostab.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rsd/groovy_workspace/FroboMind-Fuerte/vision_opencv/image_geometry/devel/lib;/opt/ros/groovy/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND image_geometry_LIBRARIES ${${image_geometry_dep}_LIBRARIES})
  _list_append_unique(image_geometry_LIBRARY_DIRS ${${image_geometry_dep}_LIBRARY_DIRS})
endforeach()

if(image_geometry_LIBRARIES)
  _remove_duplicate_libraries(image_geometry_LIBRARIES image_geometry_LIBRARIES)
endif()
